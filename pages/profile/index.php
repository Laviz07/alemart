...
<div class="main-content">
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        ...
        <!-- TOP PROFILE -->
        <?php
        $coverBg = !empty($user['avatar'])
            ? BASE_URL . '/assets/uploads/avatar/' . $user['avatar']
            : BASE_URL . '/assets/img/default-cover.jpg';
        ?>
        <div
            class="p-4 p-lg-5 text-white position-relative overflow-hidden"
            style="
                min-height: 240px;
                background:
                    linear-gradient(
                ...
                <div class="d-flex align-items-center gap-4 flex-wrap">
                    ...
                    <?php if (!empty($user['avatar'])): ?>
                        ...
                        <img
                            ...
                            alt="Avatar"
                            class="rounded-circle border border-4 border-white object-fit-cover shadow"
                            style="
                        width: 110px;
                        height: 110px;
                    ">
                    ...
                    <?php else: ?>
                        ...
                        <div
                            class="rounded-circle bg-white text-success fw-bold 
